...
# Параметры мишени (алюминий)
thickness_cm = 100e-4  # толщина в см (10e-4 = 10 мкм, 50e-4 = 50 мкм, 100e-4 = 100 мкм, 1000e-4 = 1 мм)
thickness_um = thickness_cm * 1e4  # толщина в мкм для вывода
density = 2.7  # г/см^3
A = 26.98  # г/моль
Z = 13
...
print(f"Толщина мишени: {thickness_um:.0f} мкм")
...
plt.tight_layout()
plt.savefig('klein_nishina_analysis.png', dpi=150)
print("\nГрафик сохранен в файл 'klein_nishina_analysis.png'")

# ============================================
# ВЫВОД ТАБЛИЦЫ РЕЗУЛЬТАТОВ
# ============================================
print("\n" + "="*90)
print(f"РЕЗУЛЬТАТЫ ПО БИНАМ ({n_bins} бинов, 0-80°, {thickness_um:.0f} мкм Al):")
print("="*90)
